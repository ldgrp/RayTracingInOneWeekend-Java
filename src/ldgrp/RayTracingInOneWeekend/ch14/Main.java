package ldgrp.RayTracingInOneWeekend.ch14;
...
import ldgrp.RayTracingInOneWeekend.ch10.Lambertian;
import ldgrp.RayTracingInOneWeekend.ch10.Metal;
...
public class Main {
    public static void main(String[] args) {
        ...
        var camera = new Camera(1280, 720, 100, 50, 20, new Point3(13, 2, 3), new Point3(0, 0, 0), new Vec3(0, 1, 0), 0.60, 10);
        camera.render(world);
    }
}
